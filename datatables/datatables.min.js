 ...
 *   https://datatables.net/download/#bs/jqc-1.11.3,dt-1.10.9,af-2.0.0,b-1.0.3,b-print-1.0.3,fc-3.1.0,fh-3.0.0,r-1.0.7,rr-1.0.0,sc-1.3.0,se-1.0.1
 *
 * Included libraries:
 *   jQuery compat 1.11.3, DataTables 1.10.9, AutoFill 2.0.0, Buttons 1.0.3, Print view 1.0.3, FixedColumns 3.1.0, FixedHeader 3.0.0, Responsive 1.0.7, RowReorder 1.0.0, Scroller 1.3.0, Select 1.0.1
 */
...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"tidak ada data yang ditemukan",sInfo:"Menampilkan _START_ sampai _END_ dari _TOTAL_ data",sInfoEmpty:"Menampilkan 0 sampai 0 dari 0 data",sInfoFiltered:"(filtered from _MAX_ total entri)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Tampilkan _MENU_ data",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Cari :",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
...
jQuery.fn.dataTable.ext.builder = "bs\/jqc-1.11.3,dt-1.10.9,af-2.0.0,b-1.0.3,b-print-1.0.3,fc-3.1.0,fh-3.0.0,r-1.0.7,rr-1.0.0,sc-1.3.0,se-1.0.1";
